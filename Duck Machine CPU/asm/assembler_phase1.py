    ...
    for lnum in range(len(lines)):
        ...
        try:
            ...
            if fields["kind"] == AsmSrcKind.FULL:
                ...
                transformed.append(line)  # Preserve FULL instructions as is
            elif fields["kind"] == AsmSrcKind.DATA:
                transformed.append(line)  # Preserve DATA lines as is
                ...
                transformed.append(line)  # Preserve comment lines as is
