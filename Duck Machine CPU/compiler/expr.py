...
class Seq(Control):
    ...
    def gen(self, context: Context, target: str):
        """
        Generate code for the left operand, and then for the right operand
        """
...
class Read(Expr):
    ...
    def gen(self, context: Context, target: str):
        """read a value into the target register by
        executing a LOAD instruction from memory address 510
        """
