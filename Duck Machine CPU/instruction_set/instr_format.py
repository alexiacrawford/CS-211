...
def decode(word: int) -> Instruction:
        ...
        tar = reg_target_field.extract(word)
        sr1 = reg_src1_field.extract(word)
        sr2 = reg_src2_field.extract(word)
        of = offset_field.extract_signed(word)
        return Instruction(OpCode(op), CondFlag(cond), tar, sr1, sr2, of)